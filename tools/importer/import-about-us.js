...
const PAGE_TEMPLATE = {
  name: 'about-us',
  description: 'About Us page: title, intro, and profile-card grids (Contributors, WKND Guides).',
  urls: [
  ...
  sections: [
    {
      id: 'sec1',
      name: 'Page title and Contributors intro',
...
// TRANSFORMER REGISTRY (single section → cleanup only; no section breaks needed)
const transformers = [
  cleanupTransformer,
